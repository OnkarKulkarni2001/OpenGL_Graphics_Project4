...
void cScene::CreateScene(std::string sceneFileName) {
    ...
    // I dont have uniform for setting color for now so I'll just go over every vertex from model and change its color
    for (int vertexIndex = 0; vertexIndex != pModels[0].numberOfVerticesToRender; vertexIndex++) {
        pModels[0].pVerticesToRender[vertexIndex].vertexColor.r = 0.2f;
        pModels[0].pVerticesToRender[vertexIndex].vertexColor.g = 0.2f;
        pModels[0].pVerticesToRender[vertexIndex].vertexColor.b = 0.2f;
        pModels[0].pVerticesToRender[vertexIndex].vertexColor.a = 1.0f;
    }

    for (int vertexIndex = 0; vertexIndex != pModels[1].numberOfVerticesToRender; vertexIndex++) {
        pModels[1].pVerticesToRender[vertexIndex].vertexColor.r = 0.8f;
        pModels[1].pVerticesToRender[vertexIndex].vertexColor.g = 0.8f;
        pModels[1].pVerticesToRender[vertexIndex].vertexColor.b = 0.8f;
        pModels[1].pVerticesToRender[vertexIndex].vertexColor.a = 1.0f;
    }

    for (int vertexIndex = 0; vertexIndex != pModels[3].numberOfVerticesToRender; vertexIndex++) {
        pModels[3].pVerticesToRender[vertexIndex].vertexColor.r = 0.4f;
        pModels[3].pVerticesToRender[vertexIndex].vertexColor.g = 0.4f;
        pModels[3].pVerticesToRender[vertexIndex].vertexColor.b = 0.4f;
        pModels[3].pVerticesToRender[vertexIndex].vertexColor.a = 1.0f;
    }
