...
GLuint cVAOManager::BindVAOVBO(GLuint &VBO, int numberOfMeshesToLoad, std::vector<cLoadModels> pModels) {
    ...
    const GLint vertexUV_location = glGetAttribLocation(shaderProgram, "aUV");
    ...
    glVertexAttribPointer(vertexUV_location,
        2,
        GL_FLOAT,
        GL_FALSE,
        sizeof(cLoadModels::sVerticesToRender),
        (void*)offsetof(cLoadModels::sVerticesToRender, cLoadModels::sVerticesToRender::vertexUV));
